...
\acknowledgements{I would like to thank my supervisor Ing. Vojtěch Létal, for the patience, guidance and support. I would also like to thank my family for their support.}
...
\website{https://github.com/Ivellien/pgQuery4s} %optional thesis URL
...
\begin{figure}
	\dirtree{%
	    .1 pgQuery4s\DTcomment{the directory of source codes}.
	    .2 core\DTcomment{core submodule}.
	    .2 example\DTcomment{example project}.
	    .2 macros\DTcomment{macros submodule}.
	    .2 native\DTcomment{native submodule}.
	    .2 parser\DTcomment{parser submodule}.
	    .2 project\DTcomment{metabuild}.
	    .2 thesis\DTcomment{the directory of \LaTeX  source codes of the thesis}.
	    .2 build.sbt\DTcomment{build definition}.
	    .2 README.md\DTcomment{github description of library}.
